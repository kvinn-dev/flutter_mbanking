...
class LightColor {
  ...
  // Additional BCA colors
  static const Color bcaBlue = Color(0xff003366);
  static const Color bcaDarkBlue = Color(0xff001a33);
  static const Color bcaGold = Color(0xffffcc00);
}
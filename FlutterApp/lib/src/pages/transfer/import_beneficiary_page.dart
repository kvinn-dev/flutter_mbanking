...
class ImportBeneficiaryPage extends StatelessWidget {
  const ImportBeneficiaryPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Import Beneficiary List Page - Coming Soon')),
    );
  }
}

...
class UnderlyingDocumentsPage extends StatelessWidget {
  const UnderlyingDocumentsPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Underlying Documents Page - Coming Soon')),
    );
  }
}
